...
export interface AwsIotRpiFleetProvisioningStackProps extends StackProps {
  /**
...
export class AwsIotRpiFleetProvisioningStack extends Stack {
  /**
  ...
  constructor(scope: Construct, id: string, props: AwsIotRpiFleetProvisioningStackProps) {
    ...
    // REF : https://subaud.io/blog/using-a-typescript-lambda-as-a-cdk-construct-custom-resource


    new CustomResource(this, 'ConfigureRpiImageBuilderCR', {
      serviceToken:  new cr.Provider(this, 'MyProvider', {
        onEventHandler: configureRpiImageBuilderFunction,
        //isCompleteHandler: isComplete,
        //logRetention: logs.RetentionDays.ONE_DAY,
        //role: myRole,
        providerFunctionName: 'ConfigureRpiImageBuilderCR',   // Optional
      }).serviceToken,
      properties: {
